...
class MODULACIONFMRX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fcb_win = qtgui.RangeWidget(self._fcb_range, self.set_fcb, "Frecuencia del filtro", "counter_slider", float, QtCore.Qt.Horizontal)
