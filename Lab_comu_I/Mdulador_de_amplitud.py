...
class Mdulador_de_amplitud(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Mdulador_de_amplitud")
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 125e5/16
        self.ka = ka = 1
        self.fm = fm = 1e3
        self.fc = fc = 400e6
        self.GTX = GTX = 0
        ...
        self._fc_range = qtgui.Range(50e6, 2.2e9, 1e6, 400e6, 200)
        ...
        self._GTX_win = qtgui.RangeWidget(self._GTX_range, self.set_GTX, "Ganancia del transmisor", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._Ac_win = qtgui.RangeWidget(self._Ac_range, self.set_Ac, "Amplitud portadora (Ac)", "counter_slider", float, QtCore.Qt.Horizontal)
...
def main(top_block_cls=Mdulador_de_amplitud, options=None):
